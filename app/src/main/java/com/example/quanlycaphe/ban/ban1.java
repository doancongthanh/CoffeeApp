...
public class    ban1 extends AppCompatActivity {
    ListView lv1, lv11;
    TextView txt_tongtien1;
    Button btn_tt1;
    ImageButton imgbtn_back1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_tongtien1 = findViewById(R.id.txt_tongtien6);
        lv1 = findViewById(R.id.lv6);
        lv11 = findViewById(R.id.lv66);
        btn_tt1 = findViewById(R.id.btn_tt6);
        imgbtn_back1 = findViewById(R.id.imgbtn_back6);

        imgbtn_back1.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        Log.d("ban1", "Menu Data List: " + menuDataList);  // Kiểm tra xem menu có được tải đúng không

        adapter1 = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1, menuDataList);
        lv1.setAdapter(adapter1); // Gán adapter cho lv6 để hiển thị menu
        ...
        lv11.setAdapter(adapter2); // Gán adapter cho lv66 để hiển thị các món đã chọn
            ...
            if (clickTime - lastClickTime < DOUBLE_CLICK_TIME_DELTA) { // Kiểm tra khoảng thời gian để nhận diện bấm đúp
                ...
                if (parts.length == 2) { // Đảm bảo chuỗi có đủ phần
                    try {
                        ...
                        txt_tongtien1.setText(formatCurrencyVND(totalPrice)); // Hiển thị tổng giá tiền
                    } catch (NumberFormatException e) {
                        Toast.makeText(ban1.this, "Lỗi định dạng giá tiền", Toast.LENGTH_SHORT).show();
                    }
                }
                    ...
                    if (parts.length == 2) {
                        try {
                            ...
                            if (priceParts.length == 2) {
                                ...
                                txt_tongtien1.setText(formatCurrencyVND(totalPrice));
                            }

                            adapter2.notifyDataSetChanged(); // Cập nhật giao diện lv66
                        } catch (NumberFormatException e) {
                            Toast.makeText(ban1.this, "Lỗi định dạng số lượng hoặc giá tiền", Toast.LENGTH_SHORT).show();
                        }
                    }
        ...
        btn_tt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!selectedItemsList.isEmpty()) {
                    ...
                    Log.d("ban1", "Current Date: " + currentDate); // Kiểm tra ngày hiện tại
                    ...
                    new AlertDialog.Builder(ban1.this)
                            .setTitle("Thành Công")
                            ...
                            .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    Intent intent = new Intent(ban1.this, hoadon.class);
                    ...
                    Toast.makeText(ban1.this, "Chưa có món nào để thanh toán!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
