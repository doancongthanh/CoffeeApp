...
public class ban3 extends AppCompatActivity {
    ListView lv3, lv33;
    TextView txt_tongtien3;
    Button btn_tt3;
    ImageButton imgbtn_back3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_tongtien3 = findViewById(R.id.txt_tongtien6);
        lv3 = findViewById(R.id.lv6);
        lv33 = findViewById(R.id.lv66);
        btn_tt3 = findViewById(R.id.btn_tt6);
        imgbtn_back3 = findViewById(R.id.imgbtn_back6);

        imgbtn_back3.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        lv3.setAdapter(adapter1); // Gán adapter cho lv6 để hiển thị menu
        ...
        lv33.setAdapter(adapter2); // Gán adapter cho lv66 để hiển thị các món đã chọn
            ...
            if (clickTime - lastClickTime < DOUBLE_CLICK_TIME_DELTA) { // Kiểm tra khoảng thời gian để nhận diện bấm đúp
                ...
                if (parts.length == 2) { // Đảm bảo chuỗi có đủ phần
                    try {
                        ...
                        txt_tongtien3.setText(formatCurrencyVND(totalPrice)); // Hiển thị tổng giá tiền
                    } catch (NumberFormatException e) {
                        Toast.makeText(ban3.this, "Lỗi định dạng giá tiền", Toast.LENGTH_SHORT).show();
                    }
                }
        ...
        lv33.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
                    ...
                    if (parts.length == 2) {
                        try {
                            ...
                            if (priceParts.length == 2) {
                                ...
                                txt_tongtien3.setText(formatCurrencyVND(totalPrice));
                            }

                            adapter2.notifyDataSetChanged(); // Cập nhật giao diện lv66
                        } catch (NumberFormatException e) {
                            Toast.makeText(ban3.this, "Lỗi định dạng số lượng hoặc giá tiền", Toast.LENGTH_SHORT).show();
                        }
                    }
        ...
        btn_tt3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (!selectedItemsList.isEmpty()) {
                    // Lấy ngày hiện tại dưới dạng chuỗi "yyyyMMdd"
                    String currentDate = new SimpleDateFormat("yyyyMMdd", Locale.getDefault()).format(new Date());
                    Log.d("ban3", "Current Date: " + currentDate); // Kiểm tra ngày hiện tại
                    ...
                    new AlertDialog.Builder(ban3.this)
                            .setTitle("Thành Công")
                            ...
                            .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    Intent intent = new Intent(ban3.this, hoadon.class);
                                    intent.putExtra("table_number", "3");  // Truyền số bàn
                    ...
                    Toast.makeText(ban3.this, "Chưa có món nào để thanh toán!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
