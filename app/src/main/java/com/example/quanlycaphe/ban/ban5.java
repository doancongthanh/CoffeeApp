...
public class ban5 extends AppCompatActivity {
    ListView lv5, lv55;
    TextView txt_tongtien5;
    Button btn_tt5;
    ImageButton imgbtn_back5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_tongtien5 = findViewById(R.id.txt_tongtien6);
        lv5 = findViewById(R.id.lv6);
        lv55 = findViewById(R.id.lv66);
        btn_tt5 = findViewById(R.id.btn_tt6);
        imgbtn_back5 = findViewById(R.id.imgbtn_back6);

        imgbtn_back5.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        Log.d("ban5", "Menu Data List: " + menuDataList);  // Kiểm tra xem menu có được tải đúng không

        adapter1 = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1, menuDataList);
        lv5.setAdapter(adapter1); // Gán adapter cho lv6 để hiển thị menu
        ...
        lv55.setAdapter(adapter2); // Gán adapter cho lv66 để hiển thị các món đã chọn

        HashMap<String, Integer> itemCounts = new HashMap<>();

        // Xử lý sự kiện bấm đúp trên lv6 để thêm vào lv66 và cập nhật tổng giá
        lv5.setOnItemClickListener((parent, view, position, id) -> {
            ...
            if (clickTime - lastClickTime < DOUBLE_CLICK_TIME_DELTA) { // Kiểm tra khoảng thời gian để nhận diện bấm đúp
                ...
                if (parts.length == 2) { // Đảm bảo chuỗi có đủ phần
                    try {
                        ...
                        txt_tongtien5.setText(formatCurrencyVND(totalPrice)); // Hiển thị tổng giá tiền
                    } catch (NumberFormatException e) {
                        Toast.makeText(ban5.this, "Lỗi định dạng giá tiền", Toast.LENGTH_SHORT).show();
                    }
                }
        ...
        lv55.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
                    ...
                    if (parts.length == 2) {
                        try {
                            ...
                            if (priceParts.length == 2) {
                                ...
                                txt_tongtien5.setText(formatCurrencyVND(totalPrice));
                            }

                            adapter2.notifyDataSetChanged(); // Cập nhật giao diện lv66
                        } catch (NumberFormatException e) {
                            Toast.makeText(ban5.this, "Lỗi định dạng số lượng hoặc giá tiền", Toast.LENGTH_SHORT).show();
                        }
                    }
        ...
        btn_tt5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (!selectedItemsList.isEmpty()) {
                    // Lấy ngày hiện tại dưới dạng chuỗi "yyyyMMdd"
                    String currentDate = new SimpleDateFormat("yyyyMMdd", Locale.getDefault()).format(new Date());
                    Log.d("ban5", "Current Date: " + currentDate); // Kiểm tra ngày hiện tại
                    ...
                    new AlertDialog.Builder(ban5.this)
                            .setTitle("Thành Công")
                            ...
                            .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    Intent intent = new Intent(ban5.this, hoadon.class);
                    ...
                    Toast.makeText(ban5.this, "Chưa có món nào để thanh toán!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
