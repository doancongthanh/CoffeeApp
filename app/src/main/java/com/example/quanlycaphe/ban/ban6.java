...
public class ban6 extends AppCompatActivity {
    ListView lv6, lv66;
    TextView txt_tongtien6;
    Button btn_tt6;
    ImageButton imgbtn_back6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_tongtien6 = findViewById(R.id.txt_tongtien6);
        lv6 = findViewById(R.id.lv6);
        lv66 = findViewById(R.id.lv66);
        ...
        Log.d("ban6", "Menu Data List: " + menuDataList);  // Kiểm tra xem menu có được tải đúng không

        adapter1 = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1, menuDataList);
        lv6.setAdapter(adapter1); // Gán adapter cho lv6 để hiển thị menu
        ...
        lv66.setAdapter(adapter2); // Gán adapter cho lv66 để hiển thị các món đã chọn

        HashMap<String, Integer> itemCounts = new HashMap<>();

        // Xử lý sự kiện bấm đúp trên lv6 để thêm vào lv66 và cập nhật tổng giá
        lv6.setOnItemClickListener((parent, view, position, id) -> {
            ...
            if (clickTime - lastClickTime < DOUBLE_CLICK_TIME_DELTA) { // Kiểm tra khoảng thời gian để nhận diện bấm đúp
                ...
                if (parts.length == 2) { // Đảm bảo chuỗi có đủ phần
                    try {
                        ...
                        txt_tongtien6.setText(formatCurrencyVND(totalPrice)); // Hiển thị tổng giá tiền
                    } catch (NumberFormatException e) {
                        Toast.makeText(ban6.this, "Lỗi định dạng giá tiền", Toast.LENGTH_SHORT).show();
                    }
                }
